...
import com.khuram.pose.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
        ...
        processor.addPacketCallback(
                ...
                (packet) -> {
                    ...
                    try {
                        ...
                        String landMarkText = getLandmarksDebugString(landmarks);
                        runOnUiThread(() -> binding.poseTrackingText.setText(landMarkText));

                        Log.v(TAG, landMarkText);
                    } catch (InvalidProtocolBufferException e) {
                        Log.e(TAG, "Problem with landmarks - " + e);
                    }
                });
    ...
    private static String getLandmarksDebugString(LandmarkProto.NormalizedLandmarkList landmarks) {
        ...
        for (LandmarkProto.NormalizedLandmark landmark : landmarks.getLandmarkList()) {
            Float x = Float.valueOf(twoDP.format(landmark.getX()));
            Float y = Float.valueOf(twoDP.format(landmark.getY()));
            landmarksString.append("(").append(x).append(",").append(y).append("),");
        }
        landmarksString.append("]");
